...
if TRAIN:
    ...
    imu_cols = imu_cols_base + imu_engineered_features+imu_stat_col_simplified+['roll','pitch','yaw']
    ...
    tof_cols = tof_aggregated_cols_template+thm_cols_original+TOF_ADVANCED_FEATURES
...
# [Val]: 100%|██████████| 26/26 [00:00<00:00, 32.69it/s]
# Fold 1 H-F1 = 0.8224
# Fold 1 All H-F1 = 0.8524


# Evaluating fold 2 with model gesture_two_branch_fold1.pth
# [Val]: 100%|██████████| 26/26 [00:00<00:00, 32.62it/s]
# Fold 2 H-F1 = 0.8322
# Fold 2 All H-F1 = 0.8473


# Evaluating fold 3 with model gesture_two_branch_fold2.pth
# [Val]: 100%|██████████| 26/26 [00:00<00:00, 32.89it/s]
# Fold 3 H-F1 = 0.8648
# Fold 3 All H-F1 = 0.9006


# Evaluating fold 4 with model gesture_two_branch_fold3.pth
# [Val]: 100%|██████████| 26/26 [00:00<00:00, 32.90it/s]
# Fold 4 H-F1 = 0.8670
# Fold 4 All H-F1 = 0.8939


# Evaluating fold 5 with model gesture_two_branch_fold4.pth
# [Val]: 100%|██████████| 23/23 [00:00<00:00, 33.15it/s]
# Fold 5 H-F1 = 0.8562
# Fold 5 All H-F1 = 0.8807
...
# Right Handed OOF H-F1 = 0.8793
# Right Handed OOF IMU H-F1 = 0.8529
# Right Handed OOF H-F1 + IMU H-F1 = 0.8661


# Left Handed OOF H-F1 = 0.8439
# Left Handed OOF IMU H-F1 = 0.8175
# Left Handed OOF H-F1 + IMU H-F1 = 0.8307
...
pd.DataFrame(oof, columns=['logit_' + col for col in list(le.classes_)]).to_csv(EXPORT_DIR / "oof_ver37_full.csv", index=False)
